...
public class UsingDateAndTime {
    public static void main(String[] args) {
        ...
        ld.plusDays(10); // return result is ignored (immutable class)
        System.out.println(ld);

//        ld.plusMinutes(10); //there is no plusMinutes method in LocalDate class
//        ld.addDays(10); //there is no add- methods in LocalDate class
    }
}
