...
public class ParsingDateTime {
    public static void main(String[] args) {
        ...
        anotherDate.plusMonths(5).plusDays(5); // no effect because LocalDate is immutable
        System.out.println(anotherDate);

        anotherDate = anotherDate.plusMonths(5).plusDays(5);
        System.out.println(anotherDate);

        System.out.println(formatter.format(myDate) + " == " + myDate.format(formatter));
    }
}
